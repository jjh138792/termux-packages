...
termux_step_post_get_source() {
    ...
    # ！！！【绝对纯血：直接从 AOSP 官方镜像站拉取 Android 10 分支的原生头文件】！！！
    echo "[*] 直接拉取 AOSP 官方 cutils/native_handle.h ..."
